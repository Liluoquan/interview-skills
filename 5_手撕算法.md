...
- [剑指 Offer 59 - II. 队列的最大值](https://leetcode.cn/problems/dui-lie-de-zui-da-zhi-lcof/) AND [剑指 Offer 59 - I. 滑动窗口的最大值](https://leetcode.cn/problems/hua-dong-chuang-kou-de-zui-da-zhi-lcof)（腾讯二面手撕，用一个队列记录最大值）
- [904. 水果成篮](https://leetcode.cn/problems/fruit-into-baskets/)（用哈希表作为篮子）
